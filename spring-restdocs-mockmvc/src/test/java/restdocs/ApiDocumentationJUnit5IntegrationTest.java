...
public class ApiDocumentationJUnit5IntegrationTest {
    ...
    public void crudGetExample() throws Exception {
        ...
        String tagLocation = this.mockMvc.perform(get("/crud").contentType(MediaType.APPLICATION_JSON)
        ...
        this.mockMvc.perform(get("/crud").contentType(MediaType.APPLICATION_JSON)
            .content(this.objectMapper.writeValueAsString(crud)))
            .andExpect(status().isOk())
    ...
    public void crudCreateExample() throws Exception {
        ...
        String tagLocation = this.mockMvc.perform(post("/crud").contentType(MediaType.APPLICATION_JSON)
            .content(this.objectMapper.writeValueAsString(crud)))
    ...
    public void crudPatchExample() throws Exception {
        ...
        String tagLocation = this.mockMvc.perform(patch("/crud/{id}", 10).contentType(MediaType.APPLICATION_JSON)
        ...
        this.mockMvc.perform(patch("/crud/{id}", 10).contentType(MediaType.APPLICATION_JSON)
            .content(this.objectMapper.writeValueAsString(crud)))
            .andExpect(status().isOk());
    }
    ...
    public void crudPutExample() throws Exception {
        ...
        String tagLocation = this.mockMvc.perform(put("/crud/{id}", 10).contentType(MediaType.APPLICATION_JSON)
            .content(this.objectMapper.writeValueAsString(tag)))
        ...
        this.mockMvc.perform(put("/crud/{id}", 10).contentType(MediaType.APPLICATION_JSON)
            .content(this.objectMapper.writeValueAsString(crud)))
            .andExpect(status().isAccepted());
    }
