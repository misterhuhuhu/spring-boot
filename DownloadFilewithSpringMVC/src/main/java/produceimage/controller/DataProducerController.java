package produceimage.controller;
...
public class DataProducerController {
    ...
    public @ResponseBody byte[] getImage() throws IOException {
        final InputStream in = getClass().getResourceAsStream("/produceimage/image.jpg");
    ...
    public ResponseEntity<InputStreamResource> getImageDynamicType(@RequestParam("jpg") boolean jpg) {
        ...
        final InputStream in = jpg ?
                getClass().getResourceAsStream("/produceimage/image.jpg") :
                getClass().getResourceAsStream("/produceimage/image.png");
    ...
    public @ResponseBody byte[] getFile() throws IOException {
        final InputStream in = getClass().getResourceAsStream("/produceimage/data.txt");
        return IOUtils.toByteArray(in);
    }
