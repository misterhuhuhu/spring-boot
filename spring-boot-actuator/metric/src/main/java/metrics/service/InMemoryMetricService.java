...
public class InMemoryMetricService implements MetricService {
    ...
    private final Map<String, Map<Integer, Integer>> metricMap;//请求ip 指标
    private final Map<Integer, Integer> statusMetric;//状态指标
    private final Map<String, Map<Integer, Integer>> timeMap; //请求次数 指标
